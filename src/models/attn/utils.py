...
def tensorflow_quantile_loss_moo(y, y_pred, quantile):
    """Computes quantile loss for tensorflow.
  ...
  """
    ...
    quantile_loss_1 = tf.reduce_mean(tf.squeeze(weighted_errors_1))
    quantile_loss_2 = tf.reduce_mean(tf.squeeze(weighted_errors_2))
